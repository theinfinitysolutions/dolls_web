    ...
    <Transition>
      ...
      >
        ...
        <div className='flex flex-col items-center z-20 w-11/12 lg:w-6/12'>
          ...
          <div className=' w-5/12 lg:w-3/12 flex flex-row justify-between mt-4'>
            <a
            ...
            <a href='https://www.facebook.com' target='_blank' rel='noreferrer' className='cursor-pointer'>
              <FaFacebook size={24} color='#fff' />
            </a>
            <a href='https://www.twitter.com' target='_blank' rel='noreferrer' className='cursor-pointer'>
