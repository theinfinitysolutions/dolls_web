    ...
    <Transition>
      ...
      >
        ...
        <div className='flex flex-col w-[90vw] h-full items-start relative justify-start  pt-[5vh] '>
          <h2 className='text-white text-[2rem] lg:text-[4rem] lg:leading-[4rem] font-bold '>Press Release</h2>
        ...
        <div className='flex flex-col items-start w-[90vw] mt-8'>
          <div className='flex flex-col lg:flex-row w-full justify-between items-center'>
            ...
            >
              ...
              <div className='flex flex-col items-start w-1/2 px-4 py-2'>
                <h2 className='text-white text-base lg:text-xl font-medium '>{blogRef[1].title}</h2>
                <p className='text-white/70 text-xs lg:text-base mt-3'>{blogRef[1].source}</p>
                <button
                  onClick={() => {
            ...
            >
              ...
              <div className='flex flex-col items-start w-1/2 px-4 py-2'>
                <h2 className='text-white text-base lg:text-xl font-medium '>{blogRef[3].title}</h2>
                <p className='text-white/70 text-xs lg:text-base mt-3'>{blogRef[3].source}</p>
                <button
                  onClick={() => {
          ...
          <div className='flex flex-col lg:flex-row w-full justify-between items-center mt-8'>
            ...
            >
              ...
              <div className='flex flex-col items-start w-1/2 px-4 py-2'>
                <h2 className='text-white text-base lg:text-xl font-medium '>{blogRef[0].title}</h2>
                <p className='text-white/70 text-xs lg:text-base mt-3'>{blogRef[0].source}</p>
                <button
                  onClick={() => {
            ...
            >
              ...
              <div className='flex flex-col items-start w-1/2 px-4 py-2'>
                <h2 className='text-white text-base lg:text-xl font-medium '>{blogRef[2].title}</h2>
                <p className='text-white/70 text-xs lg:text-base mt-3'>{blogRef[2].source}</p>
                <button
                  onClick={() => {
        ...
        <div className=' flex flex-col items-center lg:items-start w-[90vw] mt-[10vh]'>
          <h2 className='text-white text-[2rem] lg:text-[4rem] lg:leading-[4rem] font-bold '>Social Media</h2>
        ...
        <div className='flex flex-col items-start w-[90vw] mt-[10vh]'>
          <h2 className='text-white text-[2rem] lg:text-[4rem] lg:leading-[4rem] font-bold '>Gallery</h2>
                ...
                return (
                  <>
                    {[30, 35, 37].includes(idx + 1) ? null : (
                      ...
                      >
                        <Image
                          src={process.env.NEXT_PUBLIC_API_URL + `/dolls${idx + 1}.jpeg`}
                          layout='fill'
                          objectFit='contain'
                          loading='lazy'
