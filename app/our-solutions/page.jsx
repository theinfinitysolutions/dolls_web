...
let services = [
  {
    ...
    description: 'Tailored voiceovers to give your brand a unique and professional voice.',
    image: '/dolls40.jpeg',
  },
  {
    name: 'Copywriting for Ads & Music',
    description: 'Engaging, creative copy that resonates with audiences in advertisements and music.',
    image: '/dolls41.jpeg',
  },
  {
    name: 'High-Quality Music Productions',
    description: 'Expertly crafted music productions designed to meet industry standards.',
    image: '/dolls42.jpeg',
  },
  {
    name: 'Ready-to-Release Mix & Masters',
    description: 'Polished mixes and masters, prepared for release on all major platforms.',
    image: '/dolls44.jpeg',
  },
  {
    name: 'Multilingual Ad Jingles',
    description: 'Catchy, multilingual jingles to expand your ad’s reach and appeal to diverse audiences.',
    image: '/dolls45.jpeg',
  },
];
              ...
              return (
                ...
                >
                  ...
                  <div className=' w-full lg:w-1/2  h-full flex flex-col items-center lg:items-start justify-center px-8'>
                    ...
                    <p className=' text-xl text-white w-full text-center z-20 lg:text-start mt-4'>{item.description}</p>
                    <button
                      onClick={() => {
                        router.push('/contact');
                      }}
