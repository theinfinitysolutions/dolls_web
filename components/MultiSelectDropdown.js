...
const MultiSelectDropdown = ({ name, control }) => {
  ...
  return (
    <Select
      ...
      className=' react-select mb-4 z-30 w-full bg-transparent placeholder:text-white/70 focus:bg-transparent text-white/90 ring-0  text-xl border-b-[1px] border-red-800'
    />
  );
};
