...
let footerItemsClass = 'text-base lg:text-sm hover:underline text-quirkyReddishOrange/80';
      ...
      <div className=' max-w-screen bg-black'>
        <div className='border-t-[1px] border-[#c7c7c7]/30 mt-6 py-4 flex flex-col-reverse items-center  lg:flex-row lg:justify-between'>
          ...
          <p className='text-center text-sm text-quirkyReddishOrange'>
            &copy; {new Date().getFullYear()} {"Dole's Music. All rights reserved."}
          </p>
          <div className='flex flex-row text-sm justify-center w-full lg:w-3/12 mb-4 gap-x-4  lg:mb-0 text-quirkyReddishOrange'>
